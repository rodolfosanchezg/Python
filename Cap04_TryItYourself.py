...
pizzas = ['margerita', 'napolitan', 'pepperoni', 'sea food', 'tropical', 'mexican']
...
pizzas.append('peach and plums')

#• Add a different pizza to the list friend_pizzas.

friend_pizzas.append('beacon and tomato')
...
food_menu = ('parmesan cheese', 'steak and eggs', 'potato bacon', 'cereal and milk', 'buffalo wings')
...
#food_menu[0] = 'mushrooms soup'

#• The restaurant changes its menu, replacing two of the items with different
#foods. Add a line that rewrites the tuple, and then use a for loop to print
#each of the items on the revised menu.

food_menu = ('mushroom soup', 'chaufa rice', 'potato bacon', 'buffalo wings', 'steak and eggs')
